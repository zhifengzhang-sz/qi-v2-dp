...
All mappings between mathematical specification and implementation must follow the stability rules and change management process defined in `governance.md`. Changes to these mappings must be reviewed according to the governance guidelines.
