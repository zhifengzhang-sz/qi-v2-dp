...
The **data platform** is the platform of modeling and implementing the information flow, in other words, _the data platform provides data services for the operations_ of the investment processes.
