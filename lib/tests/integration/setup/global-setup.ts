...
import { isFailure, getError } from "../../../src/qicore/base";
import { ExternalServiceSetup, EXTERNAL_SERVICES } from "./external-services";
...
export async function teardown(): Promise<void> {
  ...
  if (globalThis.__INTEGRATION_SETUP__) {
    delete globalThis.__INTEGRATION_SETUP__;
  }
}
