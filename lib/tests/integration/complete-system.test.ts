...
import type { CryptoPriceData, CryptoMarketAnalytics } from '../../src/abstract/dsl';
  ...
  describe('End-to-End Data Flow', () => {
    ...
    it('should verify unified data format across all sources', async () => {
      ...
      if (isSuccess(analyticsResult)) {
        ...
        console.log(`✅ Unified Data Format - Market Cap: $${(analytics.totalMarketCap / 1e12).toFixed(2)}T`);
      }
    }, 15000);
  });
