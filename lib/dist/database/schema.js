...
import { pgTable, serial, integer, varchar, text, numeric, timestamp, boolean, index, primaryKey } from 'drizzle-orm/pg-core';
...
export const ohlcvData = pgTable('ohlcv_data', {
    ...
    symbolTimeframeTimeIdx: index('ohlcv_symbol_timeframe_time_idx')
        .on(table.symbol, table.timeframe, table.time),
}));
/**
