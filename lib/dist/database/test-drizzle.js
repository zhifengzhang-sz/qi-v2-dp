...
async function testDrizzleImplementation() {
    ...
    try {
        ...
        try {
            ...
            console.log('⚠️ TimescaleDB initialization skipped (may already exist):', error instanceof Error ? error.message : String(error));
        }
